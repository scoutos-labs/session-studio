...
- [ ] **0.15** README — README.md with: project description (one paragraph), screenshot placeholder, quick start (3 commands: clone, install, start), configuration (SESSION_DIR, PORT env vars), development setup (bun run dev), how to add sessions (point SESSION_DIR at your .jsonl files), tech stack summary, link to agent-runner.
